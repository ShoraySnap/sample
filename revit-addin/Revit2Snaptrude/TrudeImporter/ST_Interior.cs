...
namespace Snaptrude
{
    public class ST_Interior : ST_Abstract
    {
        ...
        public ST_Interior(JToken furnitureData)
        {
            ...
            Position = STDataConverter.GetPosition(furnitureData);
            Scaling = STDataConverter.GetScaling(furnitureData);
            Rotation = STDataConverter.GetRotation(furnitureData);
            HasRotationQuaternion = STDataConverter.HasRotationQuaternion(furnitureData);
            ...
            localCentroid = STDataConverter.ArrayToXYZ(furnitureMeshData["localBoundingBox"]["center"]);
            worldCentroid = STDataConverter.ArrayToXYZ(furnitureMeshData["worldBoundingBox"]["center"]);
