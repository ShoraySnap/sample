...
namespace TrudeImporter
{
    public class TrudeRoof : TrudeModel
    {
        ...
        private void setThickness(double thickness)
        {
            ...
            {
                this.Layers = new TrudeLayer[] { new TrudeLayer("Floor", "screed" + Command.RandomString(4), UnitsAdapter.FeetToMM(thickness), true) };
            }
            if (!foundCore)
            {
        ...
        public TrudeRoof(JToken roofData, Document newDoc, FloorType existingFloorType = null)
        {
        ...
        private void CreateDepricated(Document newDoc, JToken roofData, double thickness, FloorType existingFloorType = null)
        {
            ...
            var levelIdForfloor = Command.LevelIdByNumber[this.levelNumber];
