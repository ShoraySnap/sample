                ...
                using (SubTransaction t = new SubTransaction(GlobalVariables.Document))
                {
                    ...
                    try
                    {
                        ...
                        if (mass.AllFaceVertices != null)
                        {
                            ...
                            if (mass.Type == "Room" && (mass.RoomType != "Default" || GlobalVariables.ForForgeViewsPDFExport) && mass.BottomFaceVertices != null)
                            {
                                ...
                                TrudeRoom.StoreRoomData(levelId, mass.RoomType, directShape, profile, mass.UniqueId);
                            }
                        }
